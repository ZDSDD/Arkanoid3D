...
export function createBall(ballRadius, ballVelocity) {
    ...
    return { mesh: ball, velocity: ballVelocity, radius: ballRadius };
}
...
import floorUrl from './resources/Glow-Galaxy-Texture-Space-wallpaper_1600x1200.jpg';
export function createFloor() {
    ...
    const floorTexture = textureLoader.load(floorUrl); // Replace with the path to your texture
